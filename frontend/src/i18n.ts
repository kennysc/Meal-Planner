...
const dictionaries: Record<Locale, Dictionary> = {
  'fr-CA': {
    ...
    showShoppingList: 'Afficher l’épicerie',
    hideShoppingList: 'Masquer l’épicerie',
    weekOf: 'Semaine du',
    copyPreviousWeek: 'Copier la semaine précédente',
    loading: 'Chargement...',
    loadFailed: 'Impossible de charger l’application.',
    save: 'Enregistrer',
    saveMealOnly: 'Enregistrer le repas seulement',
    add: 'Ajouter',
    ...
    deleteRecipeConfirm: 'Supprimer cette recette de la liste? Elle restera dans l’historique des repas.',
    rosewater: 'Rosewater',
    flamingo: 'Flamingo',
    pink: 'Pink',
    mauve: 'Mauve',
  ...
  'en-CA': {
    ...
    editRecipe: 'Edit',
    deleteRecipe: 'Delete',
    deleteRecipeConfirm: 'Delete this recipe from the list? It will remain in meal history.',
    rosewater: 'Rosewater',
    flamingo: 'Flamingo',
    pink: 'Pink',
    mauve: 'Mauve',
